                ...
                <div className="container-wide">
                    ...
                    <div className="space-y-16">
                        {CATEGORIES.map((category, catIndex) => {
                            const categoryServices = MOCK_SERVICES.filter(s =>
                                ...
                                <section key={category}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {categoryServices.map((service, index) => (
                                            <Link href="#" key={service.id} className="block group h-full">
                                                <motion.div
                                                    initial={{ opacity: 0, y: 20 }}
                                                ...
                                                >
                                                    <div className={`w-full md:w-32 h-32 ${service.image} rounded-xl mb-4 md:mb-0 md:mr-6 flex-shrink-0 relative overflow-hidden`}>
                                                        {service.imageUrl && (
                                                            <Image
