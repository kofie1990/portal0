            ...
            <div className="pt-24 min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
                ...
                >
                    <div className="text-center mb-12">
                        ...
                        <h1 className="font-heading text-5xl md:text-6xl font-bold mb-6">List your item.</h1>
                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-sm font-bold tracking-wide ml-1">ITEM NAME</label>
                                    <input
                                        type="text"
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold tracking-wide ml-1">CONTACT INFO</label>
                                <input
                                    type="text"
                            ...
                            <button type="button" className="w-full bg-foreground text-background py-4 rounded-xl font-bold tracking-wide hover:opacity-90 transition-opacity flex items-center justify-center gap-2 mt-4">
